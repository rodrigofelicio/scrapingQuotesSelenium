...
class QuotesPage:
    ...
    def author_dropdown(self) -> Select:
        element = Select(self.browser.find_element(By.CSS_SELECTOR, QuotesPageLocators.AUTHOR_DROPDOWN))
        return element
    
    @property
    def tags_dropdown(self) -> Select:
        element = Select(self.browser.find_element(By.CSS_SELECTOR, QuotesPageLocators.TAG_DROPDOWN))
        return element
